  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 
        ${isMobile ? (darkMode ? "backdrop-blur-md bg-white/1 0 shadow-lg" : "backdrop-blur-md bg-black/10 shadow-lg") : "md:bg-transparent"}
        ${isMobile ? "h-17" : ""}`}
    >
      <div className="w-full flex justify-between items-center px-4">
        ...
        {/* ✅ Mobile Buttons (Dark Mode & Menu Button) */}
        {isMobile ? (
